...
IVA = ( (dbo.getSubtotalBasico(@idConsumo,@id_Tarifa) + dbo.getSubtotalIntermedio(@idConsumo,@id_Tarifa) + dbo.getSubtotalExcedente(@idConsumo,@id_Tarifa) ) *0.16),
Importe = ( dbo.getSubtotalBasico(@idConsumo,@id_Tarifa) + dbo.getSubtotalIntermedio(@idConsumo,@id_Tarifa) + dbo.getSubtotalExcedente(@idConsumo,@id_Tarifa) ) +
			( (dbo.getSubtotalBasico(@idConsumo,@id_Tarifa) + dbo.getSubtotalIntermedio(@idConsumo,@id_Tarifa) + dbo.getSubtotalExcedente(@idConsumo,@id_Tarifa) ) *0.16),
Pendiente_Pago = ( dbo.getSubtotalBasico(@idConsumo,@id_Tarifa) + dbo.getSubtotalIntermedio(@idConsumo,@id_Tarifa) + dbo.getSubtotalExcedente(@idConsumo,@id_Tarifa) ) +
			( (dbo.getSubtotalBasico(@idConsumo,@id_Tarifa) + dbo.getSubtotalIntermedio(@idConsumo,@id_Tarifa) + dbo.getSubtotalExcedente(@idConsumo,@id_Tarifa) ) *0.16)
